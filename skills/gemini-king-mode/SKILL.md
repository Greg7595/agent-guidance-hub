---
name: gemini-king-mode
description: An advanced reasoning and behavioral protocol for Gemini models.
---
...
- Upstream: https://github.com/aicodeking/yt-tutorial/blob/main/gemini-king-mode.md
